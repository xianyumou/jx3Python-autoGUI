...
def main():
    for i in range(99):
        ...
        # 右键点击 gdc.png
        click_image_in_window('剑网3.*', 'images/gdc.png', timeout, button='right')

        # 左键点击 plbz.png
        click_image_in_window('剑网3.*', 'images/plbz.png', timeout, button='left')
        ...
        # 左键点击 plsh.png
        click_image_in_window('剑网3.*', 'images/plsh.png', timeout, button='left')

        print(f'旗舰艺人和种花工作中当前循环次数：{i}', flush=True)
