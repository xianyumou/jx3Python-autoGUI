...
def perform_automation(output_callback=print, stop_event=None):
    ...
    for i in range(99):
        ...
        # 左键点击 yrkq.png
        click_image_in_window('剑网3.*', 'images/yrkq.png', timeout, button='left', output_callback=output_callback, stop_event=stop_event)

        # 右键点击 gdc.png
        click_image_in_window('剑网3.*', 'images/gdc.png', timeout, button='right', output_callback=output_callback, stop_event=stop_event)
        ...
        # 左键点击 yrgb.png
        click_image_in_window('剑网3.*', 'images/yrgb.png', timeout, button='left', output_callback=output_callback, stop_event=stop_event)
        ...
        output_callback(f'旗舰艺人和种花工作中当前循环次数：{i}')
