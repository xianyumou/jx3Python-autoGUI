...
def main():
    for i in range(99):
        ...
        # 左键点击 gb.png
        click_image_in_window('剑网3.*', 'images/gb.png', timeout, button='left')
        ...
        # 左键点击 plbz.png
        click_image_in_window('剑网3.*', 'images/yjbz.png', timeout, button='left')
        ...
        # 左键点击 plsh.png
        click_image_in_window('剑网3.*', 'images/yjsh.png', timeout, button='left')

        print(f'无界种花工作中当前循环次数：{i}', flush=True)
